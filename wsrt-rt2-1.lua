...
function execute(input)
  ...
  local transient_threshold_factor = 5.0 -- decreasing this value makes detection of transient RFI more aggressive
  ...
  for ipol, polarization in ipairs(flag_polarizations) do
    ...
    for _, representation in ipairs(flag_representations) do
      ...
      for i = 1, iteration_count - 1 do
        ...
        aoflagger.threshold_timestep_rms(converted_data, 3)
