...
function execute(input)
  ...
  local frequency_resize_factor = 20.0 -- Amount of "extra" smoothing in frequency direction
  local transient_threshold_factor = 15.0 -- decreasing this value makes detection of transient RFI more aggressive
  local time_resize_factor = 25.0 -- Amount of smoothing in time direction
  local kernel_x = 31 -- Size of the lowpass kernel in the x direction
  ...
  for ipol, polarization in ipairs(flag_polarizations) do
    ...
    for _, representation in ipairs(flag_representations) do
      ...
      for i = 1, iteration_count - 1 do
        ...
        aoflagger.threshold_timestep_rms(converted_data, 20)
        ...
        aoflagger.low_pass_filter(resized_data, kernel_x, 31, 10, 5.0)
        ...
        aoflagger.visualize(converted_data, "Residual #" .. i, i + iteration_count + 1)
    ...
    aoflagger.visualize(converted_data, "Residual #" .. iteration_count, 2 * iteration_count + 1)
  ...
  aoflagger.threshold_channel_rms(input, 3.0, true)
