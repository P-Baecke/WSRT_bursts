...
function execute(input)
  ...
  local transient_threshold_factor = 20.0 -- decreasing this value makes detection of transient RFI more aggressive
  ...
  for ipol, polarization in ipairs(flag_polarizations) do
    ...
    for _, representation in ipairs(flag_representations) do
      ...
      for i = 1, iteration_count - 1 do
        ...
        aoflagger.low_pass_filter(resized_data, 1, 31, 2.5, 1.0)
